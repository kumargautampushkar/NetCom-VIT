//Disclaimer 
// THis code is taken from geeksforgeeks as refrence
// link-> https://www.geeksforgeeks.org/rsa-algorithm-cryptography/
#include <bits/stdc++.h>
using namespace std;
...
void setkeys()
{
    int prime1 = pick_rand_prime(); // first prime number
    int prime2 = pick_rand_prime(); // second prime number
